...
namespace MyTrainer
{
    ...
    {
        public static string[] _filepathsCal;
        public static string[] _filenamesCal;
        public static DateTime[] _datesCal;
        public static string[] _stData;
        ...
        public static string FolderFootball
        {
            get
            {
                return _footballSavePath;
            }
        }
        ...
        public class ExersicePE
        {
            ...
            private bool _trainedToday = false;
            ...
            public bool TrainedToday
            {
                get
                {
                    return _trainedToday;
                }
                set
                {
                    _trainedToday = value;
            ...
            public void GatherStatsInfo()
            {
                _filepathsCal = Directory.GetFiles(_peSavePath);
                _filenamesCal = new string[_filepathsCal.Length];
                _datesCal = new DateTime[_filepathsCal.Length];
                _stData = new string[_filepathsCal.Length];

                for (int i = 0; i < _filepathsCal.Length; i++)
                {
                    _filenamesCal[i] = Path.GetFileNameWithoutExtension(_filepathsCal[i]);
                    Console.WriteLine("First " + i);
                }
                for (int i = 0; i < _filenamesCal.Length; i++)
                {
                    Console.WriteLine("Parse " + i);
                    _datesCal[i] = DateTime.Parse(_filenamesCal[i]);
                    Console.WriteLine("Read " + i);
                    _stData[i] = File.ReadAllText(_filepathsCal[i]);
        ...
        public class ExersiceFootball
        {
            ...
            public void GatherStatsInfo()
            {
                _filepathsCal = Directory.GetFiles(_footballSavePath);
                _filenamesCal = new string[_filepathsCal.Length];
                _datesCal = new DateTime[_filepathsCal.Length];
                _stData = new string[_filepathsCal.Length];
